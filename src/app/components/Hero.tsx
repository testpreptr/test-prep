      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <nav className="flex items-center justify-between mb-16">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-white">TestPrep Centre</span>
          </div>
          <div className="hidden md:flex items-center space-x-8 text-white/80">
            ...
            <a href="#" className="hover:text-white transition-colors">Practice Tests</a>
            <a href="#" className="hover:text-white transition-colors">Success Stories</a>
            <button className="bg-white/20 hover:bg-white/30 px-6 py-2 rounded-full backdrop-blur-sm border border-white/30 transition-all">
              Login
            </button>
          </div>
        </nav>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className={`transform transition-all duration-1000 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
            ...
            <p className="text-xl text-white/80 mb-8 leading-relaxed">
              ...
              comprehensive materials, and proven strategies.
            </p>
